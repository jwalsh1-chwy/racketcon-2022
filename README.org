...
Automated PR feedback (either as part of a PR or a pre-commit) still hinges heavily on defining the cultural expectations of 

Tools (linting, style guide (Black, Prettier), fixers) as part of static analysis 
